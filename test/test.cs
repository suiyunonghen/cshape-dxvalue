...
public class test : MonoBehaviour
{
    ...
    void Start()
    {
        Button btnMap = transform.Find("BtnMap").GetComponent<Button>();
        btnMap.onClick.AddListener(btnMapClick);

        btnMap = transform.Find("BtnArray").GetComponent<Button>();
        btnMap.onClick.AddListener(btnArrayClick);


        btnMap = transform.Find("Button").GetComponent<Button>();
        btnMap.onClick.AddListener(btnParseClick);

        btnMap = transform.Find("btnParse").GetComponent<Button>();
        btnMap.onClick.AddListener(btnEncodeClick);
    }
